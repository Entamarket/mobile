...
import UseSellerAccountUpdate from "../../hooks/UseSellerAccountUpdate";
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView style={styles.formContainer}>
        <View style={styles.signTextCon}>
          <Text style={styles.signInText}>Update Seller Profile</Text>
          <Text style={styles.signupText}>Change your Seller Information</Text>
        </View>
        ...
        <PhoneInput
          ...
          onChangeText={(text) => {
            const phoneCode = `+${phoneInput.current.state.code}-${text}`;
            setValue(text);
            setError({
              isVisible: false,
              display: "none",
